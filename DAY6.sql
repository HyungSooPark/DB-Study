 ...
 *  );
 * 
 *  제약조건 : 테이블에 데이터를 저장하고자 할 때 지켜야하는 규칙
...
CREATE TABLE MEMBER(
	...
	MEMBER_PWD VARCHAR(20),		--회원 비밀번호
	MEMBER_NAME VARCHAR(15)		--회원 이름
);
...
-- 컬럼 작성시 함께 제약조건 작성(컬럼레벨 제약조건 등록)

DROP TABLE USER_NOCONS;
CREATE TABLE USER_NOCONS( USER_NO NUMBER,
USER_ID VARCHAR2(20),
...
VALUES(1,'user01','pass01','박형수','남','010-1234-5678','park123@kh.or.kr');
...
-- 중복 값이 있을 경우 값 추가/수정을 못하게 막는 제약조건
INSERT INTO USER_NOCONS
VALUES(1,'user01','1234','홍길동','남','010-4333-2111','hong@exmaple.com');
...
VALUES(1,'USER01','PASS01','박형수');
INSERT INTO USER_UNIQUE3
VALUES(1,'USER02','PASS02','한예인');
INSERT INTO USER_UNIQUE3
VALUES(2,'USER01','PASS03','안승훈');
INSERT INTO USER_UNIQUE3
VALUES(2,'USER02','PASS04','홍길동');

INSERT INTO USER_UNIQUE3
VALUES(2,'USER02','PASS05','임꺽정');
...
VALUES(1,'USER01','PASS01','박형수','남');

-- ORA-12899: value too large for column "TEST"."USER_CHECK"."GENDER" 
INSERT INTO USER_CHECK
VALUES(2,'USER02','PASS02','홍길동','남자');

-- ORA-02290: check constraint (TEST.SYS_C007043) violated
INSERT INTO USER_CHECK
VALUES(2,'USER02','PASS02','홍길동','M');
...
-- 기본키 제약조건은 각 테이블마다 반드시 한 개 존재해야한다.
...
INSERT INTO USER_PK_TABLE 
VALUES(1,'USER03','PASS03','PARK','F');
-- ORA-01400: cannot insert NULL into ("TEST"."USER_PK_TABLE"."USER_NO")
INSERT INTO USER_PK_TABLE 
VALUES(NULL,'USER03','PASS03','PARK','F');

-- 기본키 제약 조건을 설정하면 NOT NULL과 UNIQUE가 함께 설정된다.
